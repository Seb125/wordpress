    ...
    <div class="container">
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          <ul>
            <li <?php if (is_page('about-us') or wp_get_post_parent_id(0) == 8)
        ...
        <div class="site-header__util">
         ...
         <?php } else { ?>
            <a href="<?php echo esc_url(site_url('/wp-login.php?loggedout=true&wp_lang=en_US')) ?>" class="btn btn--small btn--orange float-left push-right">Login</a>
